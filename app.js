...
/* ---- OFFICIAL calibration (universal indicator, measured by Amina & Luca,
   22 reference solutions verified with a pH meter). No demo flags:
   these are real points, so the beta badge stays hidden. ---- */
let calibration = [
  {ph:1.8, rgb:[107,1,6]},
  {ph:2, rgb:[119,1,10]},
  {ph:2.7, rgb:[113,0,15]},
